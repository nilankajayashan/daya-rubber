...
<head>
    ...
    <title>Daya Rubber | Order{{ '-'.$order->order_id }}</title>
    <style>
        .bg-dark {
...
<div class="m-0">
    <div class="bg-dark col-12" style="min-height: 100px; border-bottom-right-radius: 50px; border-bottom-left-radius: 50px; margin-top: 0px !important; ">
        ...
        <h1 style="color: #fff !important; text-align: center; padding-top: 25px;">Daya Rubber</h1>
...
<h4 class="mt-3">Order ID: #{{ $order->order_id }}</h4>
