                                ...
                                <form action="{{ route('add-employee') }}" method="post">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6 mb-3">
                                                <h6 class="">Suppliers</h6>
                                                <div class="form-check ms-3">
                                                    <input class="form-check-input" type="checkbox" id="view-supplier" name="view_supplier" value="view-supplier" onchange="removeOptions('view-supplier',['add-supplier','edit-supplier','delete-supplier','approve-supplier'])">
                                                    <label class="form-check-label" for="view-supplier">View Supplier</label>
                                                </div>
                                                <div class="form-check ms-3">
                                                    <input class="form-check-input" type="checkbox" id="add-supplier" name="add_supplier" value="add-supplier" onchange="setRequired('view-supplier','add-supplier',['add-supplier','edit-supplier','delete-supplier','approve-supplier'])">
                                                    <label class="form-check-label" for="add-supplier">Add Supplier</label>
                                                </div>
                                                <div class="form-check ms-3">
                                                    <input class="form-check-input" type="checkbox" id="edit-supplier" name="edit_supplier" value="edit-supplier" onchange="setRequired('view-supplier','edit-supplier',['add-supplier','edit-supplier','delete-supplier','approve-supplier'])">
                                                    <label class="form-check-label" for="edit-supplier">Edit Supplier</label>
                                                </div>
                                                <div class="form-check ms-3">
                                                    <input class="form-check-input" type="checkbox" id="approve-supplier" name="approve_supplier" value="approve-supplier"  onchange="setRequired('view-supplier','approve-supplier',['add-supplier','edit-supplier','delete-supplier','approve-supplier'])">
                                                    <label class="form-check-label" for="approve-supplier">Active/De-active Supplier</label>
                                                </div>
                                                <div class="form-check ms-3">
                                                    <input class="form-check-input" type="checkbox" id="delete-supplier" name="delete_supplier" value="delete-supplier"  onchange="setRequired('view-supplier','delete-supplier',['add-supplier','edit-supplier','delete-supplier','approve-supplier'])">
                                                    <label class="form-check-label" for="delete-supplier">Delete Supplier</label>
                                                </div>
                                            </div>
...
{{--                                        @if(isset($employees) || in_array( 'make-permission', json_decode($permissions)))--}}
{{--                                            <div class="col-lg-6 mb-3">--}}
{{--                                                <h6 class="">Permission</h6>--}}
{{--                                                <div class="form-check ms-3">--}}
{{--                                                    <input class="form-check-input" type="checkbox" id="make-permission" name="make_permission" value="make-permission">--}}
{{--                                                    <label class="form-check-label" for="make-permission">Make Permissions</label>--}}
{{--                                                </div>--}}
{{--                                            </div>--}}
{{--                                        @endif--}}
                                        </div>
                ...
                {{--            end add user modal--}}
            @endif
            <h3 class="text-light col-lg-10">Employees</h3>
            @if(in_array( 'add-employee', json_decode($permissions)))
                            ...
                            @if(in_array( 'edit-employee', json_decode($permissions)) || in_array( 'delete-employee', json_decode($permissions))| in_array( 'approve-employee', json_decode($permissions)))
                                <td>
                                    @if(in_array( 'approve-employee', json_decode($permissions)))
                                        <form action="{{ route('approve-employee') }}" method="post" class="d-inline-flex">
                                            @csrf
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-6 mb-3">
                                                            ...
                                                            <div class="form-check ms-3">
                                                                <input class="form-check-input" type="checkbox" id="manage-order-{{ $employee->employee_id }}" name="manage_order" value="manage-order" onchange="setRequired('view-order-{{ $employee->employee_id }}','manage-order-{{ $employee->employee_id }}',['add-order-{{ $employee->employee_id }}','edit-order-{{ $employee->employee_id }}','delete-order-{{ $employee->employee_id }}','manage-order-{{ $employee->employee_id }}'])" @if(in_array('edit-order', json_decode($employee->permissions))) checked="true" @endif>
                                                        ...
                                                        <div class="col-lg-6 mb-3">
                                                            <h6 class="">Suppliers</h6>
                                                            <div class="form-check ms-3">
                                                                <input class="form-check-input" type="checkbox" id="view-supplier-{{ $employee->employee_id }}" name="view_supplier" value="view-supplier" onchange="removeOptions('view-supplier-{{ $employee->employee_id }}',['add-supplier-{{ $employee->employee_id }}','edit-supplier-{{ $employee->employee_id }}','delete-supplier-{{ $employee->employee_id }}','approve-supplier-{{ $employee->employee_id }}'])" @if(in_array('view-supplier', json_decode($employee->permissions))) checked="true" @endif>
                                                                <label class="form-check-label" for="view-supplier-{{ $employee->employee_id }}">View Supplier</label>
                                                            </div>
                                                            <div class="form-check ms-3">
                                                                <input class="form-check-input" type="checkbox" id="add-supplier-{{ $employee->employee_id }}" name="add_supplier" value="add-supplier" onchange="setRequired('view-supplier-{{ $employee->employee_id }}','add-supplier-{{ $employee->employee_id }}',['add-supplier-{{ $employee->employee_id }}','edit-supplier-{{ $employee->employee_id }}','delete-supplier-{{ $employee->employee_id }}','approve-supplier-{{ $employee->employee_id }}'])" @if(in_array('add-supplier', json_decode($employee->permissions))) checked="true" @endif>
                                                                <label class="form-check-label" for="add-supplier-{{ $employee->employee_id }}">Add Supplier</label>
                                                            </div>
                                                            <div class="form-check ms-3">
                                                                <input class="form-check-input" type="checkbox" id="edit-supplier-{{ $employee->employee_id }}" name="edit_supplier" value="edit-supplier" onchange="setRequired('view-supplier-{{ $employee->employee_id }}','edit-supplier-{{ $employee->employee_id }}',['add-supplier-{{ $employee->employee_id }}','edit-supplier-{{ $employee->employee_id }}','delete-supplier-{{ $employee->employee_id }}','approve-supplier-{{ $employee->employee_id }}'])" @if(in_array('edit-supplier', json_decode($employee->permissions))) checked="true" @endif>
                                                                <label class="form-check-label" for="edit-supplier-{{ $employee->employee_id }}">Edit Supplier</label>
                                                            </div>
                                                            <div class="form-check ms-3">
                                                                <input class="form-check-input" type="checkbox" id="approve-supplier-{{ $employee->employee_id }}" name="approve_supplier" value="approve-supplier"  onchange="setRequired('view-supplier-{{ $employee->employee_id }}','approve-supplier-{{ $employee->employee_id }}',['add-supplier-{{ $employee->employee_id }}','edit-supplier-{{ $employee->employee_id }}','delete-supplier-{{ $employee->employee_id }}','approve-supplier-{{ $employee->employee_id }}'])" @if(in_array('approve-supplier', json_decode($employee->permissions))) checked="true" @endif>
                                                                <label class="form-check-label" for="approve-supplier-{{ $employee->employee_id }}">Active/De-active Supplier</label>
                                                            </div>
                                                            <div class="form-check ms-3">
                                                                <input class="form-check-input" type="checkbox" id="delete-supplier-{{ $employee->employee_id }}" name="delete_supplier" value="delete-supplier"  onchange="setRequired('view-supplier-{{ $employee->employee_id }}','delete-supplier-{{ $employee->employee_id }}',['add-supplier-{{ $employee->employee_id }}','edit-supplier-{{ $employee->employee_id }}','delete-supplier-{{ $employee->employee_id }}','approve-supplier-{{ $employee->employee_id }}'])" @if(in_array('delete-supplier', json_decode($employee->permissions))) checked="true" @endif>
                                                                <label class="form-check-label" for="delete-supplier-{{ $employee->employee_id }}">Delete Supplier</label>
                                                            </div>
                                                        </div>
