<div class="m-0">
    <div class="bg-dark col-12" style="min-height: 100px; border-bottom-right-radius: 50px;">
        <div class="row">
            <h3 class="text-light col-lg-10">Products</h3>
                        ...
                        <div class="modal-body">
                            <form action="{{ route('add-product') }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="mb-3">
                                            <select name="supplier_id" id="" class="form-control @error('supplier') is-invalid @enderror" required="required">
                                                <option value="" selected disabled>Select Supplier</option>
                                                @foreach($suppliers as $supplier)
                                                    <option value="{{ $supplier->supplier_id }}">{{ $supplier->supplier_id.' | '.$supplier->name.'@'.$supplier->company }}</option>
                                                @endforeach
                                            </select>
                                            @error('supplier')
                                            <div class="text-danger">{{ $message }}</div>
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="mb-3">
                                                            <select name="supplier_id" id="" class="form-control @error('supplier') is-invalid @enderror" required="required">
                                                                <option value="" selected disabled>Select Supplier</option>
                                                                @foreach($suppliers as $supplier)
                                                                    <option value="{{ $supplier->supplier_id }}" selected="@if($supplier->supplier_id  == $product->supplier_id ) true @endif">{{ $supplier->supplier_id.' | '.$supplier->name.'@'.$supplier->company }}</option>
                                                                @endforeach
                                                            </select>
                                                            @error('supplier')
                                                            <div class="text-danger">{{ $message }}</div>
                                                            ...
                                                            <div class="col-lg-12 mb-3 row">
                                                                ...
                                                                @foreach(json_decode($product->additional_images) as $image)
                                                                    ...
                                                                    <div class="col-lg-4 p-2 border-0 text-center" id="{{ $image }}">
                                                                        <img src="{{ asset('product_images/'.$product->product_id.'/'.$image)  }}" alt="{{ $product->name }}" class="w-75">
